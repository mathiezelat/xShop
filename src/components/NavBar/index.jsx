        ...
        <header>
            <nav>
                ...
                <ul className={`nav-links ${activeSlide ? 'nav-active nav-active-mov' : ''}`}>
                    <li><NavLink to='/' exact activeClassName="active"  onClick={onClickUp}  >Inicio</NavLink></li>
                    ...
                    <ul className={`sub-nav-links ${activeDropdown ? 'active-subnav' : ''}`}>
                        <li><NavLink to={`/category/iMac`} onClick={Dropdown}>iMac</NavLink></li>
                        <li><NavLink to={`/category/MacBook`} onClick={Dropdown}>MacBook</NavLink></li>
                        <li><NavLink to={`/category/iPhone`} onClick={Dropdown}>iPhone</NavLink></li>
                        <li><NavLink to={`/category/Watch`} onClick={Dropdown}>Watch</NavLink></li>
                    </ul>
                    </li>
